...
// LWJGL_LAZY_CURRENT_COLOR_ATTRIB_V1
// glColor changes the logical OpenGL current color. Immediate rendering captures
// that color per vertex; client-array draws with no color array materialize the
// generic WebGL attribute here, exactly when it is actually consumed.
...
function Java_org_lwjgl_opengl_GL11_nglColor4f(lib, r, g, b, a, funcPtr)
{
	...
	if(!presentationStats.lazyCurrentColorObserved) presentationStats.lazyCurrentColorObserved = true;
}
