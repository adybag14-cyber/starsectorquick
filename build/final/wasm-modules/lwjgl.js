...
// WebGL binding while preserving exact behavior when the buffer changes.
...
function bindArrayBufferCached(buffer)
{
	...
	{
		if(!presentationStats.arrayBufferBindCacheHitObserved) presentationStats.arrayBufferBindCacheHitObserved = true;
		return;
	}
