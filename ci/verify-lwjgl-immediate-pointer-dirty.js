...
const c=vm.createContext({glCtx,DataView,Float32Array,Math,Number,Set,console,clientArrayWarnings:new Set(),warnOnce(){},strictWebGLValidation:false,
 ...
 presentationStats:{immediateInterleavedDraws:0,immediateInterleavedUploads:0,immediateInterleavedUploadsSaved:0,immediateInterleavedBytes:0,immediatePointerLayoutRefreshes:0,immediateAttribEnableRefreshes:0},immediatePointerLayoutDirty:true,immediateAttribEnableDirty:true});
