        ...
        r.accept(new ClassVisitor(Opcodes.ASM9,w){
            @Override public MethodVisitor visitMethod(int access,String name,String desc,String sig,String[] ex){
                ...
                return new MethodVisitor(Opcodes.ASM9,mv){
                    ...
                    private void printStringContext(int index,String owner,String method,String label){super.visitFieldInsn(Opcodes.GETSTATIC,"java/lang/System","out","Ljava/io/PrintStream;");super.visitLdcInsn("WeaponCtorContextDiag: "+label+"=");super.visitMethodInsn(Opcodes.INVOKEVIRTUAL,"java/io/PrintStream","print","(Ljava/lang/String;)V",false);super.visitFieldInsn(Opcodes.GETSTATIC,"java/lang/System","out","Ljava/io/PrintStream;");super.visitVarInsn(Opcodes.ALOAD,index);super.visitMethodInsn(Opcodes.INVOKEVIRTUAL,owner,method,"()Ljava/lang/String;",false);super.visitMethodInsn(Opcodes.INVOKEVIRTUAL,"java/io/PrintStream","println","(Ljava/lang/String;)V",false);}
                    private void printIntContext(int index,String owner,String method,String label){super.visitFieldInsn(Opcodes.GETSTATIC,"java/lang/System","out","Ljava/io/PrintStream;");super.visitLdcInsn("WeaponCtorContextDiag: "+label+"=");super.visitMethodInsn(Opcodes.INVOKEVIRTUAL,"java/io/PrintStream","print","(Ljava/lang/String;)V",false);super.visitFieldInsn(Opcodes.GETSTATIC,"java/lang/System","out","Ljava/io/PrintStream;");super.visitVarInsn(Opcodes.ALOAD,index);super.visitMethodInsn(Opcodes.INVOKEVIRTUAL,owner,method,"()I",false);super.visitMethodInsn(Opcodes.INVOKEVIRTUAL,"java/io/PrintStream","println","(I)V",false);}
                    private void probeArgs(){if(argsProbed)return;argsProbed=true;super.visitFieldInsn(Opcodes.GETSTATIC,"java/lang/System","out","Ljava/io/PrintStream;");super.visitLdcInsn("WeaponCtorEntryDiag: A.J.<init>");super.visitMethodInsn(Opcodes.INVOKEVIRTUAL,"java/io/PrintStream","println","(Ljava/lang/String;)V",false);localProbe(1," arg weaponSpec");localProbe(2," arg slot");localProbe(3," arg ship");printStringContext(1,"com/fs/starfarer/loading/specs/N","getWeaponId","weapon");printStringContext(2,"com/fs/starfarer/loading/specs/Y","getId","slot");printIntContext(1,"com/fs/starfarer/loading/specs/N","getNumFrames","frames");printStringContext(1,"com/fs/starfarer/loading/specs/N","getHardpointGunSpriteName","hardpointGun");printStringContext(1,"com/fs/starfarer/loading/specs/N","getTurretGunSpriteName","turretGun");}
