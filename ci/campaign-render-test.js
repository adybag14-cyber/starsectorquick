...
(async () => {
  ...
  if (deepGameplay && expectedState === 'campaign' && !fatalSeenAt) {
    ...
    gameplayPerformance = {
      ...
      immediatePointEndsDelta: Number(perfAfter.immediatePointEnds || 0) - Number(perfBefore.immediatePointEnds || 0),
      immediatePointVerticesDelta: Number(perfAfter.immediatePointVertices || 0) - Number(perfBefore.immediatePointVertices || 0),
      immediateSinglePointEndsDelta: Number(perfAfter.immediateSinglePointEnds || 0) - Number(perfBefore.immediateSinglePointEnds || 0),
      immediateQuadStripEndsDelta: Number(perfAfter.immediateQuadStripEnds || 0) - Number(perfBefore.immediateQuadStripEnds || 0),
      immediateQuadStripVerticesDelta: Number(perfAfter.immediateQuadStripVertices || 0) - Number(perfBefore.immediateQuadStripVertices || 0),
      immediatePolygonEndsDelta: Number(perfAfter.immediatePolygonEnds || 0) - Number(perfBefore.immediatePolygonEnds || 0),
      immediatePolygonVerticesDelta: Number(perfAfter.immediatePolygonVertices || 0) - Number(perfBefore.immediatePolygonVertices || 0),
      immediateUnknownModeEndsDelta: Number(perfAfter.immediateUnknownModeEnds || 0) - Number(perfBefore.immediateUnknownModeEnds || 0),
      immediateUnknownModeVerticesDelta: Number(perfAfter.immediateUnknownModeVertices || 0) - Number(perfBefore.immediateUnknownModeVertices || 0),
      immediateSameModeConsecutiveEndsDelta: Number(perfAfter.immediateSameModeConsecutiveEnds || 0) - Number(perfBefore.immediateSameModeConsecutiveEnds || 0),
      immediateQuadStripNoBarrierAdjacentEndsDelta: Number(perfAfter.immediateQuadStripNoBarrierAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripNoBarrierAdjacentEnds || 0),
      immediateQuadStripReadOnlyQueryAdjacentEndsDelta: Number(perfAfter.immediateQuadStripReadOnlyQueryAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripReadOnlyQueryAdjacentEnds || 0),
      immediateQuadStripMutationBarrierAdjacentEndsDelta: Number(perfAfter.immediateQuadStripMutationBarrierAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripMutationBarrierAdjacentEnds || 0),
      immediateQuadStripMatrixBarrierAdjacentEndsDelta: Number(perfAfter.immediateQuadStripMatrixBarrierAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripMatrixBarrierAdjacentEnds || 0),
      immediateQuadStripTextureBarrierAdjacentEndsDelta: Number(perfAfter.immediateQuadStripTextureBarrierAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripTextureBarrierAdjacentEnds || 0),
      immediateQuadStripRenderStateBarrierAdjacentEndsDelta: Number(perfAfter.immediateQuadStripRenderStateBarrierAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripRenderStateBarrierAdjacentEnds || 0),
      immediateQuadStripClientBarrierAdjacentEndsDelta: Number(perfAfter.immediateQuadStripClientBarrierAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripClientBarrierAdjacentEnds || 0),
      immediateQuadStripOtherBarrierAdjacentEndsDelta: Number(perfAfter.immediateQuadStripOtherBarrierAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripOtherBarrierAdjacentEnds || 0),
      immediateQuadStripSameModelViewAdjacentEndsDelta: Number(perfAfter.immediateQuadStripSameModelViewAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripSameModelViewAdjacentEnds || 0),
      immediateQuadStripSameProjectionAdjacentEndsDelta: Number(perfAfter.immediateQuadStripSameProjectionAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripSameProjectionAdjacentEnds || 0),
      immediateQuadStripSameTextureAdjacentEndsDelta: Number(perfAfter.immediateQuadStripSameTextureAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripSameTextureAdjacentEnds || 0),
      immediateQuadStripSameMatrixTextureAdjacentEndsDelta: Number(perfAfter.immediateQuadStripSameMatrixTextureAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripSameMatrixTextureAdjacentEnds || 0),
      immediateQuadStripNoHardBarrierAdjacentEndsDelta: Number(perfAfter.immediateQuadStripNoHardBarrierAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripNoHardBarrierAdjacentEnds || 0),
      immediateQuadStripSameRenderStateAdjacentEndsDelta: Number(perfAfter.immediateQuadStripSameRenderStateAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripSameRenderStateAdjacentEnds || 0),
      immediateQuadStripBatchSafeAdjacentEndsDelta: Number(perfAfter.immediateQuadStripBatchSafeAdjacentEnds || 0) - Number(perfBefore.immediateQuadStripBatchSafeAdjacentEnds || 0),
    };
    gameplayPerformance.responsive = gameplayPerformance.swapDelta >= 20 && gameplayPerformance.recentFps >= 2;
    logs.push(`[gameplay-performance] durationMs=${gameplayPerformance.durationMs} swaps=${gameplayPerformance.swapDelta} fps=${gameplayPerformance.recentFps.toFixed(2)} frameMs=${gameplayPerformance.recentFrameMs.toFixed(2)} webglDraws=${gameplayPerformance.webglDrawDelta} quadBatches=${gameplayPerformance.quadBatchDelta} quads=${gameplayPerformance.quadCountDelta} drawCallsSaved=${gameplayPerformance.quadDrawCallsSavedDelta} interleavedDraws=${gameplayPerformance.immediateInterleavedDrawDelta} interleavedUploads=${gameplayPerformance.immediateInterleavedUploadDelta} interleavedSaved=${gameplayPerformance.immediateInterleavedUploadsSavedDelta} interleavedBytes=${gameplayPerformance.immediateInterleavedBytesDelta} modeDetail=points:${gameplayPerformance.immediatePointEndsDelta}/${gameplayPerformance.immediatePointVerticesDelta}/single:${gameplayPerformance.immediateSinglePointEndsDelta},quadStrip:${gameplayPerformance.immediateQuadStripEndsDelta}/${gameplayPerformance.immediateQuadStripVerticesDelta},polygon:${gameplayPerformance.immediatePolygonEndsDelta}/${gameplayPerformance.immediatePolygonVerticesDelta},unknown:${gameplayPerformance.immediateUnknownModeEndsDelta}/${gameplayPerformance.immediateUnknownModeVerticesDelta},sameMode:${gameplayPerformance.immediateSameModeConsecutiveEndsDelta},quadStripNoBarrierAdj:${gameplayPerformance.immediateQuadStripNoBarrierAdjacentEndsDelta},quadStripReadOnlyQueryAdj:${gameplayPerformance.immediateQuadStripReadOnlyQueryAdjacentEndsDelta},quadStripMutationBarrierAdj:${gameplayPerformance.immediateQuadStripMutationBarrierAdjacentEndsDelta},quadStripBarrierKinds:matrix:${gameplayPerformance.immediateQuadStripMatrixBarrierAdjacentEndsDelta}/texture:${gameplayPerformance.immediateQuadStripTextureBarrierAdjacentEndsDelta}/state:${gameplayPerformance.immediateQuadStripRenderStateBarrierAdjacentEndsDelta}/client:${gameplayPerformance.immediateQuadStripClientBarrierAdjacentEndsDelta}/other:${gameplayPerformance.immediateQuadStripOtherBarrierAdjacentEndsDelta},quadStripSameEffective:mv:${gameplayPerformance.immediateQuadStripSameModelViewAdjacentEndsDelta}/proj:${gameplayPerformance.immediateQuadStripSameProjectionAdjacentEndsDelta}/tex:${gameplayPerformance.immediateQuadStripSameTextureAdjacentEndsDelta}/all:${gameplayPerformance.immediateQuadStripSameMatrixTextureAdjacentEndsDelta},quadStripSafety:noHard:${gameplayPerformance.immediateQuadStripNoHardBarrierAdjacentEndsDelta}/sameState:${gameplayPerformance.immediateQuadStripSameRenderStateAdjacentEndsDelta}/safe:${gameplayPerformance.immediateQuadStripBatchSafeAdjacentEndsDelta} responsive=${gameplayPerformance.responsive}`);
  }
