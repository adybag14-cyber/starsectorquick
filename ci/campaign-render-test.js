...
(async () => {
  ...
  if (deepGameplay && expectedState === 'campaign' && !fatalSeenAt) {
    ...
    gameplayPerformance = {
      ...
      immediateQuadStripDeferredRunDelta: Number(perfAfter.immediateQuadStripDeferredRuns || 0) - Number(perfBefore.immediateQuadStripDeferredRuns || 0),
      immediateQuadStripBatchedRunDelta: Number(perfAfter.immediateQuadStripBatchedRuns || 0) - Number(perfBefore.immediateQuadStripBatchedRuns || 0),
      immediateQuadStripBatchedStripDelta: Number(perfAfter.immediateQuadStripBatchedStrips || 0) - Number(perfBefore.immediateQuadStripBatchedStrips || 0),
      immediateQuadStripDrawCallsSavedDelta: Number(perfAfter.immediateQuadStripDrawCallsSaved || 0) - Number(perfBefore.immediateQuadStripDrawCallsSaved || 0),
      immediateQuadStripBridgeVertexDelta: Number(perfAfter.immediateQuadStripBridgeVertices || 0) - Number(perfBefore.immediateQuadStripBridgeVertices || 0),
      immediateQuadStripUploadsSavedDelta: Number(perfAfter.immediateQuadStripUploadsSaved || 0) - Number(perfBefore.immediateQuadStripUploadsSaved || 0),
    };
    gameplayPerformance.responsive = gameplayPerformance.swapDelta >= 20 && gameplayPerformance.recentFps >= 2;
    logs.push(`[gameplay-performance] durationMs=${gameplayPerformance.durationMs} swaps=${gameplayPerformance.swapDelta} fps=${gameplayPerformance.recentFps.toFixed(2)} frameMs=${gameplayPerformance.recentFrameMs.toFixed(2)} webglDraws=${gameplayPerformance.webglDrawDelta} quadBatches=${gameplayPerformance.quadBatchDelta} quads=${gameplayPerformance.quadCountDelta} drawCallsSaved=${gameplayPerformance.quadDrawCallsSavedDelta} interleavedDraws=${gameplayPerformance.immediateInterleavedDrawDelta} interleavedUploads=${gameplayPerformance.immediateInterleavedUploadDelta} interleavedSaved=${gameplayPerformance.immediateInterleavedUploadsSavedDelta} interleavedBytes=${gameplayPerformance.immediateInterleavedBytesDelta} pointerRefreshes=${gameplayPerformance.immediatePointerLayoutRefreshDelta}/${gameplayPerformance.immediatePointerLayoutRefreshCount} quadStripDeferred=${gameplayPerformance.immediateQuadStripDeferredRunDelta} quadStripBatchedRuns=${gameplayPerformance.immediateQuadStripBatchedRunDelta} quadStripBatchedStrips=${gameplayPerformance.immediateQuadStripBatchedStripDelta} quadStripSaved=${gameplayPerformance.immediateQuadStripDrawCallsSavedDelta} quadStripBridges=${gameplayPerformance.immediateQuadStripBridgeVertexDelta} quadStripUploadsSaved=${gameplayPerformance.immediateQuadStripUploadsSavedDelta} responsive=${gameplayPerformance.responsive}`);
  }
