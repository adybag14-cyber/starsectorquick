...
${fallback}`);
  ...
  if (deepGameplay && expectedState === 'campaign' && !fatalSeenAt) {
    ...
    gameplayPerformance = {
      ...
      coreStateCallsDelta: Number(perfAfter.coreStateCalls || 0) - Number(perfBefore.coreStateCalls || 0),
      coreStateChangesDelta: Number(perfAfter.coreStateChanges || 0) - Number(perfBefore.coreStateChanges || 0),
      coreStateSkippedDelta: Number(perfAfter.coreStateSkipped || 0) - Number(perfBefore.coreStateSkipped || 0),
      coreStateSnapshotQueriesAvoidedDelta: Number(perfAfter.coreStateSnapshotQueriesAvoided || 0) - Number(perfBefore.coreStateSnapshotQueriesAvoided || 0),
      alphaUniformUploadsDelta: Number(perfAfter.alphaUniformUploads || 0) - Number(perfBefore.alphaUniformUploads || 0),
      alphaUniformUploadsSavedDelta: Number(perfAfter.alphaUniformUploadsSaved || 0) - Number(perfBefore.alphaUniformUploadsSaved || 0),
      textureMaskUniformUploadsDelta: Number(perfAfter.textureMaskUniformUploads || 0) - Number(perfBefore.textureMaskUniformUploads || 0),
      textureMaskUniformUploadsSavedDelta: Number(perfAfter.textureMaskUniformUploadsSaved || 0) - Number(perfBefore.textureMaskUniformUploadsSaved || 0),
    };
    gameplayPerformance.responsive = gameplayPerformance.swapDelta >= 20 && gameplayPerformance.recentFps >= 2;
    logs.push(`[gameplay-performance] durationMs=${gameplayPerformance.durationMs} swaps=${gameplayPerformance.swapDelta} fps=${gameplayPerformance.recentFps.toFixed(2)} frameMs=${gameplayPerformance.recentFrameMs.toFixed(2)} p50=${gameplayPerformance.frameP50Ms.toFixed(2)} p95=${gameplayPerformance.frameP95Ms.toFixed(2)} p99=${gameplayPerformance.frameP99Ms.toFixed(2)} max=${gameplayPerformance.frameMaxMs.toFixed(2)} jitterStdDev=${gameplayPerformance.frameJitterStdDevMs.toFixed(2)} jitterP95=${gameplayPerformance.frameJitterP95Ms.toFixed(2)} longFrames=${gameplayPerformance.longFrameDelta} droppedEstimate=${gameplayPerformance.droppedFrameEstimateDelta} webglDraws=${gameplayPerformance.webglDrawDelta} quadBatches=${gameplayPerformance.quadBatchDelta} quads=${gameplayPerformance.quadCountDelta} drawCallsSaved=${gameplayPerformance.quadDrawCallsSavedDelta} coreStateCalls=${gameplayPerformance.coreStateCallsDelta} coreStateChanges=${gameplayPerformance.coreStateChangesDelta} coreStateSkipped=${gameplayPerformance.coreStateSkippedDelta} coreQueriesAvoided=${gameplayPerformance.coreStateSnapshotQueriesAvoidedDelta} alphaUploads=${gameplayPerformance.alphaUniformUploadsDelta} alphaSaved=${gameplayPerformance.alphaUniformUploadsSavedDelta} texMaskUploads=${gameplayPerformance.textureMaskUniformUploadsDelta} texMaskSaved=${gameplayPerformance.textureMaskUniformUploadsSavedDelta} responsive=${gameplayPerformance.responsive}`);
  }
