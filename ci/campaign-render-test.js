...
${fallback}`);
  ...
  if (deepGameplay && expectedState === 'campaign' && !fatalSeenAt) {
    ...
    gameplayPerformance = {
      ...
      matrixInPlaceOpsDelta: Number(perfAfter.matrixInPlaceOps || 0) - Number(perfBefore.matrixInPlaceOps || 0),
      matrixTempAllocationsAvoidedDelta: Number(perfAfter.matrixTempAllocationsAvoided || 0) - Number(perfBefore.matrixTempAllocationsAvoided || 0),
      matrixLegacyOpsDelta: Number(perfAfter.matrixLegacyOps || 0) - Number(perfBefore.matrixLegacyOps || 0),
    };
    gameplayPerformance.responsive = gameplayPerformance.swapDelta >= 20 && gameplayPerformance.recentFps >= 2;
    logs.push(`[gameplay-performance] durationMs=${gameplayPerformance.durationMs} swaps=${gameplayPerformance.swapDelta} fps=${gameplayPerformance.recentFps.toFixed(2)} frameMs=${gameplayPerformance.recentFrameMs.toFixed(2)} p50=${gameplayPerformance.frameP50Ms.toFixed(2)} p95=${gameplayPerformance.frameP95Ms.toFixed(2)} p99=${gameplayPerformance.frameP99Ms.toFixed(2)} max=${gameplayPerformance.frameMaxMs.toFixed(2)} jitterStdDev=${gameplayPerformance.frameJitterStdDevMs.toFixed(2)} jitterP95=${gameplayPerformance.frameJitterP95Ms.toFixed(2)} longFrames=${gameplayPerformance.longFrameDelta} droppedEstimate=${gameplayPerformance.droppedFrameEstimateDelta} webglDraws=${gameplayPerformance.webglDrawDelta} quadBatches=${gameplayPerformance.quadBatchDelta} quads=${gameplayPerformance.quadCountDelta} drawCallsSaved=${gameplayPerformance.quadDrawCallsSavedDelta} matrixInPlaceOps=${gameplayPerformance.matrixInPlaceOpsDelta} matrixTempAllocAvoided=${gameplayPerformance.matrixTempAllocationsAvoidedDelta} matrixLegacyOps=${gameplayPerformance.matrixLegacyOpsDelta} responsive=${gameplayPerformance.responsive}`);
  }
