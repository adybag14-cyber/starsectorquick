...
${fallback}`);
  ...
  if (deepGameplay && expectedState === 'campaign' && !fatalSeenAt) {
    ...
    gameplayPerformance = {
      ...
      matrixUniformUploadDelta: Number(perfAfter.matrixUniformUploads || 0) - Number(perfBefore.matrixUniformUploads || 0),
      matrixUniformSavedDelta: Number(perfAfter.matrixUniformUploadsSaved || 0) - Number(perfBefore.matrixUniformUploadsSaved || 0),
      vertexAttribPointerUpdateDelta: Number(perfAfter.vertexAttribPointerUpdates || 0) - Number(perfBefore.vertexAttribPointerUpdates || 0),
      vertexAttribPointerSavedDelta: Number(perfAfter.vertexAttribPointerUpdatesSaved || 0) - Number(perfBefore.vertexAttribPointerUpdatesSaved || 0),
      vertexAttribEnableChangeDelta: Number(perfAfter.vertexAttribEnableChanges || 0) - Number(perfBefore.vertexAttribEnableChanges || 0),
      vertexAttribEnableSavedDelta: Number(perfAfter.vertexAttribEnableChangesSaved || 0) - Number(perfBefore.vertexAttribEnableChangesSaved || 0),
      vertexBufferUploadDelta: Number(perfAfter.vertexBufferUploads || 0) - Number(perfBefore.vertexBufferUploads || 0),
      vertexUploadBytesDelta: Number(perfAfter.vertexUploadBytes || 0) - Number(perfBefore.vertexUploadBytes || 0),
    };
    gameplayPerformance.responsive = gameplayPerformance.swapDelta >= 20 && gameplayPerformance.recentFps >= 2;
    logs.push(`[gameplay-performance] durationMs=${gameplayPerformance.durationMs} swaps=${gameplayPerformance.swapDelta} fps=${gameplayPerformance.recentFps.toFixed(2)} frameMs=${gameplayPerformance.recentFrameMs.toFixed(2)} p50=${gameplayPerformance.frameP50Ms.toFixed(2)} p95=${gameplayPerformance.frameP95Ms.toFixed(2)} p99=${gameplayPerformance.frameP99Ms.toFixed(2)} max=${gameplayPerformance.frameMaxMs.toFixed(2)} jitterStdDev=${gameplayPerformance.frameJitterStdDevMs.toFixed(2)} jitterP95=${gameplayPerformance.frameJitterP95Ms.toFixed(2)} longFrames=${gameplayPerformance.longFrameDelta} droppedEstimate=${gameplayPerformance.droppedFrameEstimateDelta} webglDraws=${gameplayPerformance.webglDrawDelta} quadBatches=${gameplayPerformance.quadBatchDelta} quads=${gameplayPerformance.quadCountDelta} drawCallsSaved=${gameplayPerformance.quadDrawCallsSavedDelta} matrixUniformUploads=${gameplayPerformance.matrixUniformUploadDelta} matrixUniformSaved=${gameplayPerformance.matrixUniformSavedDelta} attribPointerUpdates=${gameplayPerformance.vertexAttribPointerUpdateDelta} attribPointerSaved=${gameplayPerformance.vertexAttribPointerSavedDelta} attribEnableChanges=${gameplayPerformance.vertexAttribEnableChangeDelta} attribEnableSaved=${gameplayPerformance.vertexAttribEnableSavedDelta} vertexBufferUploads=${gameplayPerformance.vertexBufferUploadDelta} vertexUploadBytes=${gameplayPerformance.vertexUploadBytesDelta} responsive=${gameplayPerformance.responsive}`);
  }
