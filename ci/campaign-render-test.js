...
${fallback}`);
  ...
  if (deepGameplay && expectedState === 'campaign' && !fatalSeenAt) {
    ...
    gameplayPerformance = {
      ...
      clientArrayAttributeUploadDelta: Number(perfAfter.clientArrayAttributeUploads || 0) - Number(perfBefore.clientArrayAttributeUploads || 0),
      clientArrayUploadBytesDelta: Number(perfAfter.clientArrayUploadBytes || 0) - Number(perfBefore.clientArrayUploadBytes || 0),
      immediateEndDelta: Number(perfAfter.immediateEnds || 0) - Number(perfBefore.immediateEnds || 0),
      immediateAttributeUploadDelta: Number(perfAfter.immediateAttributeUploads || 0) - Number(perfBefore.immediateAttributeUploads || 0),
      immediateUploadBytesDelta: Number(perfAfter.immediateUploadBytes || 0) - Number(perfBefore.immediateUploadBytes || 0),
      immediateSingleQuadEndsDelta: Number(perfAfter.immediateSingleQuadEnds || 0) - Number(perfBefore.immediateSingleQuadEnds || 0),
      immediateMultiQuadEndsDelta: Number(perfAfter.immediateMultiQuadEnds || 0) - Number(perfBefore.immediateMultiQuadEnds || 0),
      immediateTriangleEndsDelta: Number(perfAfter.immediateTriangleEnds || 0) - Number(perfBefore.immediateTriangleEnds || 0),
      immediateLineEndsDelta: Number(perfAfter.immediateLineEnds || 0) - Number(perfBefore.immediateLineEnds || 0),
      immediateOtherEndsDelta: Number(perfAfter.immediateOtherEnds || 0) - Number(perfBefore.immediateOtherEnds || 0),
      immediateVerticesDelta: Number(perfAfter.immediateVertices || 0) - Number(perfBefore.immediateVertices || 0),
    };
    gameplayPerformance.responsive = gameplayPerformance.swapDelta >= 20 && gameplayPerformance.recentFps >= 2;
    logs.push(`[gameplay-performance] durationMs=${gameplayPerformance.durationMs} swaps=${gameplayPerformance.swapDelta} fps=${gameplayPerformance.recentFps.toFixed(2)} frameMs=${gameplayPerformance.recentFrameMs.toFixed(2)} p50=${gameplayPerformance.frameP50Ms.toFixed(2)} p95=${gameplayPerformance.frameP95Ms.toFixed(2)} p99=${gameplayPerformance.frameP99Ms.toFixed(2)} max=${gameplayPerformance.frameMaxMs.toFixed(2)} jitterStdDev=${gameplayPerformance.frameJitterStdDevMs.toFixed(2)} jitterP95=${gameplayPerformance.frameJitterP95Ms.toFixed(2)} longFrames=${gameplayPerformance.longFrameDelta} droppedEstimate=${gameplayPerformance.droppedFrameEstimateDelta} webglDraws=${gameplayPerformance.webglDrawDelta} quadBatches=${gameplayPerformance.quadBatchDelta} quads=${gameplayPerformance.quadCountDelta} drawCallsSaved=${gameplayPerformance.quadDrawCallsSavedDelta} clientUploads=${gameplayPerformance.clientArrayAttributeUploadDelta}/${gameplayPerformance.clientArrayUploadBytesDelta} immediateEnds=${gameplayPerformance.immediateEndDelta} immediateUploads=${gameplayPerformance.immediateAttributeUploadDelta}/${gameplayPerformance.immediateUploadBytesDelta} drawShape=singleQuad:${gameplayPerformance.immediateSingleQuadEndsDelta},multiQuad:${gameplayPerformance.immediateMultiQuadEndsDelta},tri:${gameplayPerformance.immediateTriangleEndsDelta},line:${gameplayPerformance.immediateLineEndsDelta},other:${gameplayPerformance.immediateOtherEndsDelta},verts:${gameplayPerformance.immediateVerticesDelta} responsive=${gameplayPerformance.responsive}`);
  }
