...
(async () => {
  ...
  if (deepGameplay && expectedState === 'campaign' && !fatalSeenAt) {
    ...
    gameplayPerformance = {
      ...
      immediateCompactColorDrawDelta: Number(perfAfter.immediateCompactColorDraws || 0) - Number(perfBefore.immediateCompactColorDraws || 0),
      immediateCompactColorVertexDelta: Number(perfAfter.immediateCompactColorVertices || 0) - Number(perfBefore.immediateCompactColorVertices || 0),
      immediateCompactColorBytesSavedDelta: Number(perfAfter.immediateCompactColorBytesSaved || 0) - Number(perfBefore.immediateCompactColorBytesSaved || 0),
      immediateCompactColorFallbackDrawDelta: Number(perfAfter.immediateCompactColorFallbackDraws || 0) - Number(perfBefore.immediateCompactColorFallbackDraws || 0),
      immediateCompactColorBackfillVertexDelta: Number(perfAfter.immediateCompactColorBackfillVertices || 0) - Number(perfBefore.immediateCompactColorBackfillVertices || 0),
    };
    gameplayPerformance.responsive = gameplayPerformance.swapDelta >= 20 && gameplayPerformance.recentFps >= 2;
    logs.push(`[gameplay-performance] durationMs=${gameplayPerformance.durationMs} swaps=${gameplayPerformance.swapDelta} fps=${gameplayPerformance.recentFps.toFixed(2)} frameMs=${gameplayPerformance.recentFrameMs.toFixed(2)} webglDraws=${gameplayPerformance.webglDrawDelta} quadBatches=${gameplayPerformance.quadBatchDelta} quads=${gameplayPerformance.quadCountDelta} drawCallsSaved=${gameplayPerformance.quadDrawCallsSavedDelta} interleavedDraws=${gameplayPerformance.immediateInterleavedDrawDelta} interleavedUploads=${gameplayPerformance.immediateInterleavedUploadDelta} interleavedSaved=${gameplayPerformance.immediateInterleavedUploadsSavedDelta} interleavedBytes=${gameplayPerformance.immediateInterleavedBytesDelta} compactColor=${gameplayPerformance.immediateCompactColorDrawDelta}/${gameplayPerformance.immediateCompactColorVertexDelta} compactSavedBytes=${gameplayPerformance.immediateCompactColorBytesSavedDelta} compactFallback=${gameplayPerformance.immediateCompactColorFallbackDrawDelta}/${gameplayPerformance.immediateCompactColorBackfillVertexDelta} responsive=${gameplayPerformance.responsive}`);
  }
