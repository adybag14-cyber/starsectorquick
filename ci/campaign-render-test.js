...
(async () => {
  ...
  if (deepGameplay && expectedState === 'campaign' && !fatalSeenAt) {
    ...
    gameplayPerformance = {
      ...
      vertexAttribPointerCacheHitObserved: Boolean(perfAfter.vertexAttribPointerCacheHitObserved),
      vertexAttribEnableCacheHitObserved: Boolean(perfAfter.vertexAttribEnableCacheHitObserved),
