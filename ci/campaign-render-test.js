...
${fallback}`);
  ...
  if (deepGameplay && expectedState === 'campaign' && !fatalSeenAt) {
    ...
    gameplayPerformance = {
      ...
      attribPushDelta: Number(perfAfter.attribPushCount || 0) - Number(perfBefore.attribPushCount || 0),
      attribPopDelta: Number(perfAfter.attribPopCount || 0) - Number(perfBefore.attribPopCount || 0),
      attribSnapshotQueriesAvoidedDelta: Number(perfAfter.attribSnapshotQueriesAvoided || 0) - Number(perfBefore.attribSnapshotQueriesAvoided || 0),
      attribSnapshotQueriesExecutedDelta: Number(perfAfter.attribSnapshotQueriesExecuted || 0) - Number(perfBefore.attribSnapshotQueriesExecuted || 0),
    };
    gameplayPerformance.responsive = gameplayPerformance.swapDelta >= 20 && gameplayPerformance.recentFps >= 2;
    logs.push(`[gameplay-performance] durationMs=${gameplayPerformance.durationMs} swaps=${gameplayPerformance.swapDelta} fps=${gameplayPerformance.recentFps.toFixed(2)} frameMs=${gameplayPerformance.recentFrameMs.toFixed(2)} p50=${gameplayPerformance.frameP50Ms.toFixed(2)} p95=${gameplayPerformance.frameP95Ms.toFixed(2)} p99=${gameplayPerformance.frameP99Ms.toFixed(2)} max=${gameplayPerformance.frameMaxMs.toFixed(2)} jitterStdDev=${gameplayPerformance.frameJitterStdDevMs.toFixed(2)} jitterP95=${gameplayPerformance.frameJitterP95Ms.toFixed(2)} longFrames=${gameplayPerformance.longFrameDelta} droppedEstimate=${gameplayPerformance.droppedFrameEstimateDelta} webglDraws=${gameplayPerformance.webglDrawDelta} quadBatches=${gameplayPerformance.quadBatchDelta} quads=${gameplayPerformance.quadCountDelta} drawCallsSaved=${gameplayPerformance.quadDrawCallsSavedDelta} attribPushes=${gameplayPerformance.attribPushDelta} attribPops=${gameplayPerformance.attribPopDelta} attribQueriesAvoided=${gameplayPerformance.attribSnapshotQueriesAvoidedDelta} attribQueriesExecuted=${gameplayPerformance.attribSnapshotQueriesExecutedDelta} responsive=${gameplayPerformance.responsive}`);
  }
