...
function make(enabled){
  ...
  const c=vm.createContext({
    ...
    presentationStats:{immediateInterleavedDraws:0,immediateInterleavedUploads:0,immediateInterleavedUploadsSaved:0,immediateInterleavedBytes:0,immediatePointEnds:0,immediatePointVertices:0,immediateSinglePointEnds:0,immediateQuadStripEnds:0,immediateQuadStripVertices:0,immediatePolygonEnds:0,immediatePolygonVertices:0,immediateUnknownModeEnds:0,immediateUnknownModeVertices:0,immediateSameModeConsecutiveEnds:0,immediateQuadStripNoBarrierAdjacentEnds:0,immediateQuadStripReadOnlyQueryAdjacentEnds:0,immediateQuadStripMutationBarrierAdjacentEnds:0,immediateQuadStripMatrixBarrierAdjacentEnds:0,immediateQuadStripTextureBarrierAdjacentEnds:0,immediateQuadStripRenderStateBarrierAdjacentEnds:0,immediateQuadStripClientBarrierAdjacentEnds:0,immediateQuadStripOtherBarrierAdjacentEnds:0},
    lastImmediateEndMode:-1, immediateProfileBarrierGeneration:0, immediateProfileReadOnlyQueryGeneration:0, immediateProfileMatrixBarrierGeneration:0, immediateProfileTextureBarrierGeneration:0, immediateProfileRenderStateBarrierGeneration:0, immediateProfileClientBarrierGeneration:0, immediateProfileOtherBarrierGeneration:0, immediateProfileHardBarrierGeneration:0, lastImmediateEndBarrierGeneration:-1, lastImmediateEndReadOnlyQueryGeneration:-1, lastImmediateEndMatrixBarrierGeneration:-1, lastImmediateEndTextureBarrierGeneration:-1, lastImmediateEndRenderStateBarrierGeneration:-1, lastImmediateEndClientBarrierGeneration:-1, lastImmediateEndOtherBarrierGeneration:-1, lastImmediateEndHardBarrierGeneration:-1, immediateProfileRenderSignature:()=>'',
