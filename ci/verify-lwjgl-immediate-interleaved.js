...
function make(enabled){
  ...
  const c=vm.createContext({
    ...
    lastImmediateEndMode:-1, immediateProfileBarrierGeneration:0, immediateProfileReadOnlyQueryGeneration:0, lastImmediateEndBarrierGeneration:-1, lastImmediateEndReadOnlyQueryGeneration:-1,
