...
function make(enabled){
  ...
  const c=vm.createContext({
    ...
    presentationStats:{immediateInterleavedDraws:0,immediateInterleavedUploads:0,immediateInterleavedUploadsSaved:0,immediateInterleavedBytes:0,immediatePointerLayoutRefreshes:0,arrayBufferBindCacheHitObserved:false},
    immediatePointerLayoutDirty:true,arrayBufferBindCacheEnabled:true,currentArrayBufferBinding:null,
