...
cp "$ROOT/ci/patch-secondary-counter-trim-telemetry.py" "$WORKTREE/ci/patch-secondary-counter-trim-telemetry.py"
...
if ! (
  ...
  python3 ci/patch-secondary-counter-trim-telemetry.py
