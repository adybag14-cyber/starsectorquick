...
def main():
    ...
    a, c, b = by['baseline-a'], by['pointer-dirty'], by['baseline-b']
    c['drift_adjusted'] = {}
    ...
    print('\n'.join(lines))
    for name, expected_ref in [('baseline-a', BASELINE_SHA), ('baseline-b', BASELINE_SHA), ('pointer-dirty', CANDIDATE_SHA)]:
        r = by[name]
