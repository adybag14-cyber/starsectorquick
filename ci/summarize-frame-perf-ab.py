...
ORDER = ['baseline-a', 'matrix-inplace', 'baseline-b']
BASELINE_SHA = 'a4c20a8e4b5abb5ccb2e470ad5479b3387750155'
CANDIDATE_SHA = '325b9886d2022051ffcebd90835785de682e0760'
SEED = 'SEK968276040'
WORLD = (218, 917, 59, 21)
...
def main():
    ...
    a, c, b = by['baseline-a'], by['matrix-inplace'], by['baseline-b']
    c['drift_adjusted'] = {}
    ...
    lines = [
        '# Production vs lean matrix in-place same-runner A/B', '',
    ...
    d = c['drift_adjusted']
    lines += ['', 'Drift-adjusted matrix-inplace delta:']
    for metric in ('fps','frame_ms','p95_ms','p99_ms','jitter_p95_ms'):
        v = d[metric]
    ...
    print('\n'.join(lines))
    for name, expected_ref in [('baseline-a', BASELINE_SHA), ('baseline-b', BASELINE_SHA), ('matrix-inplace', CANDIDATE_SHA)]:
        r = by[name]
