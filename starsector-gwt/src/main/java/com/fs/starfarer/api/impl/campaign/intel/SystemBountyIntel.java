...
public class SystemBountyIntel extends BaseIntelPlugin implements EveryFrameScript, FleetEventListener {
	...
	public SystemBountyIntel(MarketAPI market, int baseReward, boolean commerceMode) {
		...
		log.info(Misc.format("Starting bounty at market [%s], %d credits per frigate", market.getName(), (int) baseBounty));
	...
	protected void notifyEnding() {
		super.notifyEnding();
		log.info(Misc.format("Ending bounty at market [%s]", market.getName()));
