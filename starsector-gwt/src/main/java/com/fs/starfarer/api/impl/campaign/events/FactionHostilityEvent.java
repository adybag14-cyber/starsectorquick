...
public class FactionHostilityEvent extends BaseEventPlugin {
	...
	public void startEvent() {
		...
		log.info(Misc.format("Starting hostility event: %s -> %s", one.getDisplayName(), two.getDisplayName()));
	...
	protected void startHostilities() {
		log.info(Misc.format("Making factions hostile: %s -> %s", one.getDisplayName(), two.getDisplayName()));
