...
//	}
	...
	public String getCompletionFlag() {
		return "$" + getMissionId() + "var_underscore" + commodityId + "var_underscore" + uid + "_completed";
	}
	...
	public void reportEconomyTick(int iterIndex) {
		...
		FDNode paymentNode = report.getNode(colonyNode, getMissionId() + "var_underscore" + commodityId + "var_underscore" + uid);
