...
//		}
	...
	protected void printStats() {
		...
		print(Misc.format("Star systems: %4d", totalSystems));
		print(Misc.format("Planets:      %4d", totalPlanets));
		print(Misc.format("Habitable     %4d", totalHab));
		print(Misc.format("Planets in systems with terran worlds: %4d", totalPlanetsInSystemsWithTerran));
		print(Misc.format("Max planets in system with terran world: %4d", maxPlanetsInSystemsWithTerran));
		if (totalPlanets > 0) {
			print("Planet totals:");
			for (String type : list) {
				...
				value += " (" + count + ")";
				print(Misc.format("  %-20s%10s", type, value));
			}
			print("");
		}
