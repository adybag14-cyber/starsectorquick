...
public class WeightedRandomPicker<T>  {
	...
	public WeightedRandomPicker<T> clone() {
		WeightedRandomPicker<T> copy = new WeightedRandomPicker<T>(ignoreWeights);
...
//	}
	...
	public void print(String title) {
		...
		for (T item : sorted) {
			...
			System.out.println(Misc.format("    %-30s%10s%10s", itemStr, percent, Misc.getRoundedValue(weight)));
		}
