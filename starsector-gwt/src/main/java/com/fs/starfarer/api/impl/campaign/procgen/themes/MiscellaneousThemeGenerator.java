...
//			system.addTag(Tags.THEME_DERELICT);
		...
		if (DEBUG) {
			if (entity != null) {
				System.out.println(Misc.format("  Added coronal tap to %s", system.getNameWithLowercaseType()));
			} else {
				System.out.println(Misc.format("  Failed to add coronal tap to %s", system.getNameWithLowercaseType()));
			}
		}
		return entity;
	}
