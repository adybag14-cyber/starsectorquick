...
//		}
		...
		if (DEBUG) {
			System.out.println(Misc.format("Adding %d survey ships near mothership", surveyShipsNearMothership));
		}
		...
		if (DEBUG) {
			System.out.println(Misc.format("Adding up to %d survey ships", numSurveyShipsInNearConstellations));
		}
		...
		for (Constellation c : constellationsForSurveyShips) {
			...
			int k = 0;
			if (DEBUG) {
				System.out.println(Misc.format("Adding probes to %d constellations near survey ship", probeSystemsNearShip));
			}
...
//		}
		...
		if (DEBUG) {
			if (entity != null) {
				System.out.println(Misc.format("  Added mothership to %s", system.getNameWithLowercaseType()));
			} else {
				System.out.println(Misc.format("  Failed to add mothership to %s", system.getNameWithLowercaseType()));
			}
		}
		return entity;
	}
	...
	protected AddedEntity addCryosleeper(StarSystemAPI system, String name) {
		...
		if (DEBUG) {
			if (entity != null) {
				System.out.println(Misc.format("  Added cryosleeper to %s", system.getNameWithLowercaseType()));
			} else {
				System.out.println(Misc.format("  Failed to add cryosleeper to %s", system.getNameWithLowercaseType()));
			}
		}
		return entity;
	}
	...
	protected AddedEntity addSurveyShip(StarSystemAPI system) {
		...
		if (DEBUG) {
			if (entity != null) {
				System.out.println(Misc.format("  Added survey ship to %s", system.getNameWithLowercaseType()));
			} else {
				System.out.println(Misc.format("  Failed to add survey ship to %s", system.getNameWithLowercaseType()));
			}
		}
		return entity;
	}
	...
	protected List<AddedEntity> addProbes(StarSystemAPI system, int num) {
		...
		for (int i = 0; i < num; i++) {
			...
			if (DEBUG) {
				if (probe != null) {
					System.out.println(Misc.format("  Added probe to %s", system.getNameWithLowercaseType()));
				} else {
					System.out.println(Misc.format("  Failed to add probe to %s", system.getNameWithLowercaseType()));
				}
			}
		}
		return result;
