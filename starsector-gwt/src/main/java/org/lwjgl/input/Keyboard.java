...
@JsType(namespace = JsPackage.GLOBAL, name = "gwtKeyboard")
public class Keyboard {
    ...
    public static final int KEY_LMETA           = 0xDB; /* Left Windows key */
    public static final int KEY_RMETA           = 0xDC; /* Right Windows key */
