...
mvn_path = r"C:\Users\adyba\ss2-wasm	ools\apache-maven-3.9.6\bin\mvn.cmd"
java_home = r"C:\Users\adyba\ss2-wasm	ools\jdk-11.0.21+9"

env = os.environ.copy()
env["JAVA_HOME"] = java_home

jars = [
    ("libs/fs.common_obf.jar", "com.fs", "fs-common", "0.97a"),
    ...
    ("libs/lwjgl_util.jar", "org.lwjgl", "lwjgl-util", "2.9.3"),
...
os.chdir(r"C:\Users\adyba\ss2-wasm\starsector-gwt")
